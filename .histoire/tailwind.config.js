  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        slideDown: {
          from: { height: 0 },
          to: { height: 'var(--destyler-collapsible-content-height)' },
        },
        slideUp: {
          from: { height: 'var(--destyler-collapsible-content-height)' },
          to: { height: 0 },
        },
        enterFromRight: {
        ...
        open2D: {
          ...
          to: {
            width: 'var(--destyler-collapse-content-width)',
        ...
        swipeOut: {
          from: { transform: 'translateX(var(--destyler_toast_swipe_end_x))' },
