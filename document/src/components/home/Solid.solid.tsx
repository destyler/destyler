      ...
      <div class="mt-0! py-24 sm:py-32 hidden lg:block !pt-12 bg-gradient-to-b from-background/900 to-background/950">
        <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl gap-16 sm:gap-y-24 flex flex-col mt-0!">
          <div class="flex flex-col lg:grid gap-8 relative lg:grid-cols-10 lg:gap-8 overflow-hidden p-px mt-0!">
            <div ref={el => refs[1] = el} class="mt-0! col-span-8 flex items-center homeDemoAnimateTop p-10px">
              <SliderExample />
            </div>

            <div ref={el => refs[2] = el} class="mt-0! col-span-2 row-span-2 flex items-center homeDemoAnimateRight">
              <RadioExample />
            </div>

            <div ref={el => refs[4] = el} class="col-span-1 homeDemoAnimateLeft z-10 mt-0!">
              <DropdownExample />
            </div>

            <div ref={el => refs[3] = el} class="col-span-7 flex flex-wrap mt-0! items-center justify-between gap-1 homeDemoAnimateBottom">
              <ImageExample />
              <HoverCardExample />
            ...
            <div ref={el => refs[5] = el} class="mt-0! col-span-3 row-span-8 gap-6 flex flex-col justify-between homeDemoAnimateLeft">
            ...
            <div ref={el => refs[6] = el} class="col-span-5 row-span-2 flex flex-col homeDemoAnimateBottom">
              <ProgressExample />
              <CollapseExample />
            </div>

            <div ref={el => refs[7] = el} class="col-span-2 row-span-2 gap-6 flex flex-col homeDemoAnimateRight z-10">
              <CheckboxExample />
              <ComboboxExample />
              <SelectExample />
              <NumberInputExample />
