...
head:
  - tag: title
    content: Getting Started - Destyler
...
import PopoverVue from '@component/popover/snippets/Popover.vue'
import PopoverReact from '@component/popover/snippets/Popover.react'
import PopoverSvelte from '@component/popover/snippets/Popover.svelte'
import PopoverSolid from '@component/popover/snippets/Popover.solid'
...
- Can be [controlled or uncontrolled](/guide/controllable-state) (`defaultOpen` / `open` + `onOpenChange`, and the same pattern for checked/value).
