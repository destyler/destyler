...
<template>
  <div class="mt-0!">
    <button
      ...
      class="focus:outline-none disabled:cursor-not-allowed disabled:opacity-75 flex-shrink-0 font-medium rounded-md text-sm gap-x-2.5 px-3.5 py-2.5 shadow-sm text-primary-foreground! bg-primary! hover:bg-primary/90! focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-light-500 group-data-[theme=dark]:focus-visible:outline-light-400 inline-flex items-center"
    >
      Open popover
    </button>
