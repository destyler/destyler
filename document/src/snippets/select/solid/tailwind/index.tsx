  ...
  return (
    <>
      <div class="flex flex-col outline-none!">
        <button
          {...api().getTriggerProps()}
          class="group flex h-10 w-full items-center outline-none! justify-between rounded-md border border-input bg-background px-3 py-2 text-sm transition-colors hover:bg-accent hover:text-accent-foreground disabled:cursor-not-allowed disabled:opacity-50"
        >
