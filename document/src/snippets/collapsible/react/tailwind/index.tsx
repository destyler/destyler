  ...
  return (
    ...
    >
      <div className="flex items-center justify-between space-x-4 px-4">
        ...
        <button
          className="group m-0 w-6 h-6 hover:bg-background p-1 rounded-md flex justify-center items-center"
          {...api.getTriggerProps()}
        >
          <div
      ...
      <div
        className="overflow-hidden rounded-b-md animate-slide-container"
        {...api.getContentProps()}
      >
        <div className="rounded-md text-primary border border-border px-4 py-2 font-mono text-sm shadow-sm mt-2">
          @destyler/react
        </div>
        <div className="rounded-md text-primary border border-border px-4 py-2 font-mono text-sm shadow-sm mt-2">
          react
