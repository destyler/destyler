  ...
  <div>
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div class="menu-separator" v-bind="api.getSeparatorProps()" />
        <ul
        ...
        >
          <li
            ...
            class="menu-item"
          >
            <div class="menu-item-icon" :class="item.icon" />
            {{ item.label }}
            <span v-if="item?.shortcut" class="menu-item-shortcut">
              {{ item.shortcut }}
            </span>
          </li>
          <div v-if="index < items.length - 1" class="menu-separator" v-bind="api.getSeparatorProps()" />
        </ul>
      </div>
    </Teleport>
  </div>
