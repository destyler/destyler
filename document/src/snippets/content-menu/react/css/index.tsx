...
export default function Menu() {
  ...
  return (
    <div>
      ...
      >
        <div className="context-menu-trigger-text">Open context menu</div>
      </button>
      {api.open && createPortal(
        ...
        >
          ...
          <div className="context-menu-separator" {...api.getSeparatorProps()} />
          {items.map((itemList, index) => (
            ...
            >
              {itemList.map(item => (
                ...
                >
                  <div className={`context-menu-item-icon ${item.icon}`} />
                  {item.label}
                  {item.shortcut && (
