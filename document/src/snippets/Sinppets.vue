...
import AspectRatio from './aspect-ratio/AspectRatio.vue'
...
import ContentMenu from './content-menu/ContentMenu.vue'
...
<template>
  <div class="min-w-150px flex justify-center items-center mt-0!">
    ...
    <Collapse class="w-450px!" v-if="props.name === 'collapse'" />
    ...
    <Progress class="w-450px!" v-if="props.name === 'progress'" />
