  ...
  return (
    <div {...api().getRootProps()} class="mt-0!">
      ...
      <div {...api().getControlProps()} class="flex items-center gap-3 mt-1.5!">
        ...
        >
          <div {...api().getTransparencyGridProps({ size: '8px' })} class="absolute inset-0 bg-transparent! [background-image:none]!" />
          <div {...api().getSwatchProps({ value: api().value })} class="absolute mt-0! inset-0 w-full h-full bg-[--color]" />
        </button>
          ...
          <div {...api().getPositionerProps()} class="fixed mt-2 z-180!">
            <div {...api().getContentProps()} class="rounded-md border border-input bg-popover p-3 text-popover-foreground shadow-md outline-none">
              <div {...api().getAreaProps()} class="relative w-48 h-32 mb-3">
                <div {...api().getAreaBackgroundProps()} class="absolute inset-0 rounded-md w-full h-full" />
                <div {...api().getAreaThumbProps()} class="absolute w-3 h-3 -translate-x-1.5 -translate-y-1.5 border-2 border-white rounded-full shadow-sm cursor-pointer ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2" />
              </div>
              ...
              <div {...api().getChannelSliderProps({ channel: 'alpha' })} class="relative h-4">
                <div {...api().getTransparencyGridProps({ size: '8px' })} class="absolute inset-0 rounded-md" />
