  ...
  <DialogRoot v-model:open="dialogStatus">
    ...
    <DialogPortal>
      ...
      <DialogContent
        ...
        z-50 grid w-full sm:max-w-3xl h-dvh sm:h-[28rem]
        ...
        "
      >
        <div class="flex flex-col space-y-1.5 text-center sm:text-left h-full">
          <ComboboxRoot v-model="model" :default-open="true" class="relative h-full">
            ...
            <ComboboxViewport class="relative flex-1 h-full overflow-y-scroll border-t border-border">
              <ComboboxContent class="">
                ...
                <ComboboxGroup v-for="item in sidebar" :key="item.text" class="p-2">
                  <ComboboxLabel class="px-2.5 my-2 text-xs font-semibold text-gray-900 dark:text-white">
                    {{ item.text }}
                  </ComboboxLabel>
                  <div class="text-sm text-gray-700 dark:text-gray-200">
                    ...
                    >
                      <div class="flex items-center gap-1.5 min-w-0">
                        <Icon name="heroicons:book-open" class="flex-shrink-0 w-5 h-5" />
                        <div class="flex items-center gap-1.5 min-w-0">
