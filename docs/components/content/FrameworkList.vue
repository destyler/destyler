...
<template>
  <Box>
    ...
    <FrameworkCard dark-icon="logos:electron" light-icon="logos:electron" title="Electron" />
    <FrameworkCard dark-icon="simple-icons:nativescript" light-icon="simple-icons:nativescript" title="NativeScript" />
  </Box>
</template>
