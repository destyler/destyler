...
const disabledComponent = testid('disabled-edit')
const readonlyComponent = testid('readonly-edit')
const invalidComponent = testid('invalid-edit')
const requiredComponent = testid('required-edit')
...
export async function RendersCorrectly() {
  ...
  await expect.element(componentEl).toHaveAttribute('data-scope', 'edit')
}
