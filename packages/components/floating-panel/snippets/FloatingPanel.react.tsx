                ...
                <div {...api.getHeaderProps()}>
                  ...
                  <div className="flex mt-0! items-center gap-1">
                    <button {...api.getMinimizeTriggerProps()}>
                      <div className="w-4 h-4 i-ph:minus-bold"></div>
                    </button>
                    <button {...api.getMaximizeTriggerProps()}>
                      <div className="w-4 h-4 i-ph:arrows-out-simple-bold"></div>
                    </button>
                    <button {...api.getRestoreTriggerProps()}>
                      <div className="w-4 h-4 i-ph:arrow-down-left-bold"></div>
                    </button>
                    <button {...api.getCloseTriggerProps()}>
                      <div className="w-4 h-4 i-ph:x-bold"></div>
                    </button>
                  </div>
                </div>
              </div>
