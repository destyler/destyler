// Source: https://github.com/oku-ui/primitives/blob/main/packages/vue/src/primitive/types.ts
import type {
...
export type DestylerElement<T extends keyof NodeElementTagNameMap, TA extends boolean = true> = {
