...
<template>
  <Story title="Progress/Default" :layout="{ type: 'single', iframe: true }">
    <Variant title="Loop">
      <ProgressRoot
        v-model="interactive"
    ...
    <Variant title="Indeterminate">
      ...
      >
        ...
        <code class="text-green7">indeterminate</code>.
      </p>
    </Variant>
    <Variant title="Errors">
      ...
      <div class="px-2 py-3 rounded-sm bg-slate11 text-slate2">
        <p class="mb-4 text-sm rounded-md text-white">
        ...
        >
          ...
          />
          <div
            class="absolute font-mono text-xs font-bold text-center text-red11 pointer-events-none"
          >
        ...
        <div class="flex flex-wrap gap-2 mt-3 text-sm">
          <button
            class="px-2 py-1 rounded-md text-slate8 bg-slate2 hover:bg-slate3 h-max"
            @click="errorCaseValue = 1000"
          >
            Set <code class="text-green11">value</code> to 1000
          </button>
          <button
            class="px-2 py-1 rounded-md text-slate8 bg-slate2 hover:bg-slate3 h-max"
