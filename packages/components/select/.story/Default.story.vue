...
import SelectItemWrapper from './components/SelectItem.vue'

const fruit = ref('Leek')
...
<template>
  <Story title="Select/Default" :layout="{ type: 'single', iframe: false }">
        ...
        >
          ...
          <SelectPortal>
            <Transition>
              ...
              >
                <SelectScrollUpButton
                  class="flex items-center justify-center h-[25px] bg-white text-green11 cursor-default"
                >
                ...
                <SelectViewport class="p-[5px]">
                  ...
                  <SelectGroup>
                    <SelectItem
                      ...
                      :key="index"
                      class="text-[13px] leading-none text-green11 rounded-[3px] flex items-center h-[25px] pr-[35px] pl-[25px] relative select-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none data-[highlighted]:outline-none data-[highlighted]:bg-green9 data-[highlighted]:text-green1"
                      :value="option"
