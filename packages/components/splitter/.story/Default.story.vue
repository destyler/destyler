...
import { SplitterGroup, SplitterPanel, SplitterResizeHandle } from '../src'
</script>

<template>
  <Story title="Splitter/Default" :layout="{ type: 'single', iframe: false }">
    <Variant title="default">
      <div class="w-full h-48">
        <SplitterGroup direction="horizontal">
          ...
          <SplitterResizeHandle class="w-2 data-[state=active]:bg-white transition" />
          <SplitterPanel :max-size="20" class="flex items-center justify-center bg-blackA8 rounded-lg">
            Panel C
          </SplitterPanel>
        </SplitterGroup>
      </div>
