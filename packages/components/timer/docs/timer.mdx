...
<StyleTable component="timer" nodeType="Item" />

#### Item Label

<StyleTable component="timer" nodeType="ItemLabel" />

#### Item Value

<StyleTable component="timer" nodeType="ItemValue" />
