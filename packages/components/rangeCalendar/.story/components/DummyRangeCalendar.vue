...
import { RangeCalendarCell, RangeCalendarCellTrigger, RangeCalendarGrid, RangeCalendarGridBody, RangeCalendarGridHead, RangeCalendarGridRow, RangeCalendarHeadCell, RangeCalendarHeader, RangeCalendarHeading, RangeCalendarNext, RangeCalendarPrev, RangeCalendarRoot, type RangeCalendarRootProps } from '../../src'

const props = defineProps<{
  as?: any | undefined
  asChild?: boolean | undefined
  defaultPlaceholder?: any | undefined
  ...
  weekdayFormat?: any | undefined
  calendarLabel?: any | undefined
  ...
  isDateDisabled?: any | undefined
  isDateUnavailable?: any | undefined
}>()
const emits = defineEmits(['update:startValue', 'update:placeholder', 'update:modelValue'])
...
<template>
  ...
  >
    <RangeCalendarHeader class="flex items-center justify-between">
      ...
      >
        <Icon name="radix-icons:chevron-left" class="w-6 h-6" />
      </RangeCalendarPrev>
      <RangeCalendarHeading class="text-[15px] text-black font-medium" />
      <RangeCalendarNext
        class="inline-flex items-center cursor-pointer text-black justify-center rounded-lg bg-transparent w-10 h-10 hover:bg-black hover:text-white active:scale-98 active:transition-all focus:shadow-[0_0_0_2px] focus:shadow-black"
      >
        <Icon name="radix-icons:chevron-right" class="w-6 h-6" />
      </RangeCalendarNext>
    </RangeCalendarHeader>
    <div
