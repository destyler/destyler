...
import upresence from '~/solid/presence'
import { upresenceTestSuite } from './spec'

let Tests: upresenceTestSuite

describe('presence solid browser tests', () => {
  beforeEach(async () => {
    render(upresence)
    Tests = new upresenceTestSuite()
  })
