...
const disabledComponent = testid('disabled-tooltip')
const nestedComponent = testid('nested-tooltip')
...
export async function RendersCorrectly() {
  ...
  await expect.element(componentEl).toHaveAttribute('data-scope', 'tooltip')
}
