<Props
  :value="[
    ...
    },
    {
      ...
      default: 'false',
      description: 'The controlled checked state of the item. Can be used as <code>v-model:checked</code>.',
    },
    {
      name: 'disabled',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'string',
      default: '-',
      description: 'Optional text used for typeahead purposes. By default the typeahead behavior will use the .textContent of the item.<br />Use this when the content is complex, or you have non-textual content inside.',
    },
  ]"
/>
