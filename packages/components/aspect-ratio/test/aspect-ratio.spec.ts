...
const disabledComponent = testid('disabled-aspect-ratio')
const readonlyComponent = testid('readonly-aspect-ratio')
const invalidComponent = testid('invalid-aspect-ratio')
const requiredComponent = testid('required-aspect-ratio')
...
export async function RendersCorrectly() {
  ...
  await expect.element(componentEl).toHaveAttribute('data-scope', 'aspect-ratio')
}
