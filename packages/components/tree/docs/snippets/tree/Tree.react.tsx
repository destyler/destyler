...
import TreeNode from './TreeNode.react.tsx'
...
export default function Tree() {
  ...
  return (
    <main className="relative max-w-300px rounded-2xl border border-border/40 bg-card p-2 text-card-foreground shadow-xl shadow-black/8 mt-0!">
      <div {...api.getRootProps()} className="w-full mt-0!">
        <div {...api.getTreeProps()} className="space-y-1 mt-0!">
