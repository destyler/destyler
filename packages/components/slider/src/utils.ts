...
export const [injectSliderOrientationContext, provideSliderOrientationContext] = createContext<SliderOrientation>(['DestylerSliderVertical', 'DestylerSliderHorizontal'])
