...
<template>
  <Story title="Radio/Demo" :layout="{ type: 'single', iframe: false }">
    <Variant title="default">
      ...
      >
        <div class="flex items-center">
          <RadioGroupItem
            id="r1"
            class="bg-white w-[25px] h-[25px] rounded-full shadow-[0_2px_10px] shadow-blackA7 hover:bg-green3 focus:shadow-[0_0_0_2px] focus:shadow-black outline-none cursor-default data-[disabled]:bg-red-500"
            value="default"
          >
            <RadioGroupIndicator
              class="flex items-center justify-center w-full h-full relative after:content-[''] after:block after:w-[11px] after:h-[11px] after:rounded-[50%] after:bg-green11"
            />
          </RadioGroupItem>
