  ...
  >
    ...
    <div class="flex items-center">
      <RadioGroupItem
        ...
        aria-label="Compact"
        as-child
        class="bg-black w-[25px] h-[25px] rounded-full shadow-[0_2px_10px] shadow-blackA7 hover:bg-dark focus:shadow-[0_0_0_2px] focus:shadow-black outline-none cursor-default"
        value="compact"
      >
        <button>
          <RadioGroupIndicator
