...
describe('combobox controllable open (Phase 3)', () => {
  ...
  it('phase 3 presence: open alone (no flag) defers OPEN (idle stays idle)', () => {
...
describe('combobox controllable value (Phase 3)', () => {
  const services: Array<ReturnType<typeof machine>> = []
