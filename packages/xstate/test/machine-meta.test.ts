...
describe("Guards", () => {
  ...
  test("should work with 'and' guard", () => {
  ...
  test("should work with 'or' guard", () => {
    let actionExecuted = false
  ...
  test("should work with 'not' guard", () => {
    let actionExecuted = false
  ...
  test("should work with nested guard combinations", () => {
    let result = ""
  ...
  test("should work with string-based guards", () => {
    let actionExecuted = false
  ...
  test("should handle multiple guards with stateIn", () => {
    let results: string[] = []
  ...
  test("should handle guards in transitions with multiple conditions", () => {
  ...
  test("should handle guard errors gracefully", () => {
  ...
  test("should work with guards returning false", () => {
    let actionExecuted = false
  ...
  test("should evaluate guards in correct order", () => {
