...
describe("deepMerge", () => {
  ...
  test("preserves non-enumerable properties behavior", () => {
    const obj1 = {}
    const obj2 = {}
  ...
  test("handles large flat objects", () => {
    const obj1: any = {}
    const obj2: any = {}
  ...
  test("handles objects with complex nested arrays", () => {
    const obj1 = {
      matrix: [[1, 2], [3, 4]],
  ...
  test("handles JSON.parse prototype pollution attempt", () => {
  ...
  test("maintains type consistency with numbers", () => {
    const obj1 = { value: 42 }
  ...
  test("maintains type consistency with booleans", () => {
  ...
  test("continues merging after encountering non-enumerable properties", () => {
    const obj1 = { a: 1, b: 2 }
    const obj2 = { c: 3 }
  ...
  test("handles objects with toString/valueOf overrides", () => {
    const obj1 = {
  ...
  // Mutation Tests
  test("does not mutate source objects unnecessarily", () => {
  ...
  test("preserves object references when no merge needed", () => {
  ...
  test("merges multiple objects with overlapping nested structures", () => {
  ...
  test("handles multiple objects with different types for same key", () => {
