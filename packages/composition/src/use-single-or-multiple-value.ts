...
import type { Type } from '@destyler/shared'
...
function validateModelValue(
  ...
  if (type === 'single') {
    if (Array.isArray(modelValue)) {
      console.error(`Invalid prop \`value\` of value \`${modelValue}\` supplied to \`CollapseRoot\`, which type is \`single\`. The \`value\` prop must be:
  - a string
  - \`undefined\`

If you want to use multiple values, use the \`CollapseRoot\` with type \`multiple\`.
...
Defaulting to \`undefined\`.`)
    ...
    if (typeof modelValue === 'string' || typeof modelValue === 'undefined') {
      console.error(`Invalid prop \`value\` of value \`${modelValue}\` supplied to \`CollapseRoot\`, which type is \`multiple\`. The \`value\` prop must be:
- an array of strings
- empty array (\`[]\`)

If you want to use just one value, use the \`CollapseRoot\` with type \`single\`.
...
function getDefaultValue({ type, defaultValue }: Props) {
  if (type === 'multiple') {
    if (Array.isArray(defaultValue)) {
      ...
      console.error(
        `Invalid prop \`defaultValue\` of value \`${defaultValue}\` supplied to \`CollapseRoot\`, which type is \`multiple\`. The \`defaultValue\` prop must be:
  - an array of strings
  - empty array (\`[]\`)
...
Defaulting to empty array (\`[]\`).`,
    ...
    if (typeof defaultValue === 'string') {
      ...
      console.error(
        `Invalid prop \`defaultValue\` of value \`${defaultValue}\` supplied to \`CollapseRoot\`, which type is \`single\`. The \`defaultValue\` prop must be:
  - a string
  - \`undefined\`
