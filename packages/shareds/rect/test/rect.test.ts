...
import { createRect, getRectCorners } from '../index'
...
describe('@zag-js/rect-utils', () => {
  ...
  it('should create rect from point', () => {
  ...
  it('should get the intersection of two rects', () => {
  ...
  it('should get the collision edges between rects', () => {
