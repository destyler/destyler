...
import { parseColor, normalizeColor } from "../index"
...
describe("Color Parsing Tests", () => {
  ...
  test("parse invalid colors should throw", () => {
...
describe("Color Channel Operations", () => {
  ...
  test("channel value percentages", () => {
...
describe("Comprehensive Color Space Tests", () => {
  test("common colors across formats", () => {
    const testColors = [
    ...
    testColors.forEach(({ name, hex, rgb, hsl }) => {
