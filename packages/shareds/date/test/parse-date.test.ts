...
describe('parse date', () => {
  ...
  it('with just month/day/year [shortform]', () => {
  ...
  it('with just month/day/year [shortform - different locale]', () => {
  ...
  it('with just month/day/year [malformed year - different locale]', () => {
  ...
  it('handles European date format (dd/mm/yyyy)', () => {
  ...
  it('handles Russian date format', () => {
  ...
  it('handles 2-digit year at century boundary', () => {
  ...
  it('handles 2-digit year in current century', () => {
  ...
  it('handles 3-digit year padding', () => {
  ...
  it('validates day boundaries for different months', () => {
    const monthDays = [
  ...
  it('handles whitespace and extra characters gracefully', () => {
    const inputs = [
      ' 12/25/2023 ',
      '12/25/2023\n',
      '12/25/2023\t',
  ...
  it('returns CalendarDate object with correct properties', () => {
