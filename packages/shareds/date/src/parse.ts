...
const isValidMonth = (month: string | null | undefined): month is string => month != null && Number.parseFloat(month) <= 12
const isValidDay = (day: string | null | undefined): day is string => day != null && Number.parseFloat(day) <= 31
